...
public class StefsAPI {
	...
	public static class MessageHandler {
		...
		public static String NORMAL() {
			return AdminEye.config.getFile().getString("chat.normal");
		}

		public static String WARNING() {
			return AdminEye.config.getFile().getString("chat.warning");
		}

		public static String ERROR() {
			return AdminEye.config.getFile().getString("chat.error");
		}

		public static String ARGUMENT() {
			return AdminEye.config.getFile().getString("chat.argument");
		}

		public static String HEADER() {
			return AdminEye.config.getFile().getString("chat.header");
		}

		public static String TAG() {
			return AdminEye.config.getFile().getString("chat.header")
					+ AdminEye.config.getFile().getString("chat.tag")
					+ AdminEye.config.getFile().getString("chat.normal");
		}
	}
	...
	public static class PermissionHandler {
		public static boolean hasPermission(Player player, String permission,
			...
			if (typePermission == PermissionType.ALL) {
				...
				if (player.hasPermission(AdminEye.mainPermission + "admin")) {
					return true;
				}
				...
				if (player.hasPermission(AdminEye.mainPermission + "player")) {
					return true;
				}
			}
			...
			if (player.hasPermission("*")) {
				return true;
			} else if (player.hasPermission(AdminEye.mainPermission + "*")) {
				return true;
			} else if (player.hasPermission(AdminEye.mainPermission
					+ permission)) {
				return true;
